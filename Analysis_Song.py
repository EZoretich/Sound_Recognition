...
song = glob('C:/Users/elena/Desktop/University Stuff/3rd Year/Final Major Project/Code/*.wav')
...
ra, sr = librosa.load(song[0])
anote = ra[122000:127000]
#plot_wave(anote)
#spectrogram(anote)
'''
print(anote)
...
for x in anote:
    ...
    if x == max(anote):
        ...
        print(peak)
print(len(anote))
anote = anote[402:5000]
print(len(anote))
spectrogram(anote)'''
#A = ra[0:26000]
#B = ra[49000:75000]
#C = ra[100000:130000]
'''duration = librosa.get_duration(y = ra, sr = sr)
print("Song t =  ", duration)
dur_a = librosa.get_duration(y = A, sr = sr)
print("A t = ", dur_a)
dur_b = librosa.get_duration(y = B, sr = sr)
print("B t = ", dur_b)
dur_c = librosa.get_duration(y = C, sr = sr)
print("C t = ", dur_c)'''
#plot_wave(ra)
#spectrogram(ra)
# --- I CANNOT PLAY AUDIO ---
